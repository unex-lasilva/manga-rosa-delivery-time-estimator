...
public class BinaryTree<T extends Comparable<T>> implements Tree<T> {
    ...
    protected BinaryTreeNode<T> addRecursive(BinaryTreeNode<T> current, T value){
        if(current == null){
    ...
    protected BinaryTreeNode<T> find(BinaryTreeNode<T> current, T value){
        if(current == null){
            return null;
        }
        if(value.compareTo(current.getValue()) == 0){
    ...
    protected BinaryTreeNode<T> removeRecursive(BinaryTreeNode<T> current, T value){
        if(current == null){
            return null;
        }
        if(value.compareTo(current.getValue()) == 0){
    ...
    protected int countElements(BinaryTreeNode<T> current){
        if(current == null){
            return 0;
        }
